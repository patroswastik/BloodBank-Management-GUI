            ...
            Class.forName("oracle.jdbc.driver.OracleDriver");
                ...
                if(dmobile.equals("")){
                    if(daddress.equals("")){
                        ...
                        sm.executeQuery("update donor set daddress = '"+daddress+"' where d_id = "+Integer.parseInt(did));
                    }
                }
                    ...
                    if(dmobile.equals("")){
                        ...
                        sm.executeQuery("update donor set mobile_no = "+Long.parseLong(dmobile)+" where d_id = "+Integer.parseInt(did));
                    }
                }
                else{
                    sm.executeQuery("update donor set mobile_no = "+Long.parseLong(dmobile)+" where d_id = "+Integer.parseInt(did));
